<template>
  <section id="skills" class="py-12 md:py-20 p-6 md:p-8 bg-base-100/50 backdrop-blur-sm">
    <h2 class="font-light text-3xl sm:text-4xl lg:text-5xl font-raleway text-center mb-12 md:mb-20">My Areas of Expertise</h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mx-auto justify-items-center place-content-center">
        ...
        <div v-for="(category, index) in listOfSkillCategories" :key="index"
          ...
          <div class="card-body flex flex-col items-center p-2 py-4">
            ...
            <h3 class="card-title font-normal text-xl md:text-2xl lg:text-3xl mb-4 text-center">{{ category.category }}</h3>
